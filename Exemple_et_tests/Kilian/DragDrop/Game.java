...
public class Game{
	...
	*/
	public static void loadScenes(){ //Fonction qui load les scenes (wow explicite/20)
		sceneIndex = new Scene[3];//On initialise la liste avec le nombre de scenes que l'on a
		currentscene = 2;//On initialise l'id de la scene actuelle
		Bateau.loadBoatImages();
		sceneIndex[0] = new Menu();
		sceneIndex[1] = new Credits();
		sceneIndex[2] = new TestG();
	}
